  ...
  return (
    <CustomComponent>
      <div className="w-full md:w-[400px] lg:w-[400px] mx-auto my-5 md:my-16 flex flex-col items-start px-5">
        ...
        {/* Buttons */}
        <div className="flex w-full max-w-md mt-6 gap-4">
          <button
            onClick={() => navigate("/bookingDetailsComplete")}
            className="bg-[#0084BF] text-white w-full py-3 rounded-lg font-semibold"
          >
            Accept
          </button>
          <button className="border border-[#0D0D0D] text-[#0D0D0D] w-full py-3 rounded-lg font-semibold">
            Cancel
          </button>
        </div>
      </div>
